<template>
	<div class="diy_details_box diy_div_registration_reservation">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "registration_reservation",
					source_field: "registration_reservation_id",
					source_id: this.obj["registration_reservation_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/registration_reservation/set?registration_reservation_id=' + _this.obj["registration_reservation_id"], {
								praise_len
							}, (res) => {
								if(res.result){
