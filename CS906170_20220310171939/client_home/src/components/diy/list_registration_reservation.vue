<template>
	<div class="diy_home diy_list diy_registration_reservation" id="diy_registration_reservation_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/registration_reservation/details?registration_reservation_id=' + o['registration_reservation_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/registration_reservation/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/registration_reservation/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','appointment_description')">预约说明
					</th>
					...
					<th class="diy_title" v-if="$check_field('get','reservation_number')">预约号数
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','appointment_description')">
						<span>
							{{ o["appointment_description"] }}
						</span>
					</td>
					...
					<td class="diy_field diy_number" v-if="$check_field('get','reservation_number')">
						<span>
