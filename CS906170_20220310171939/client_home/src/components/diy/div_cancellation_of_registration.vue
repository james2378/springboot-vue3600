<template>
	<div class="diy_details_box diy_div_cancellation_of_registration">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "cancellation_of_registration",
					source_field: "cancellation_of_registration_id",
					source_id: this.obj["cancellation_of_registration_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/cancellation_of_registration/set?cancellation_of_registration_id=' + _this.obj["cancellation_of_registration_id"], {
								praise_len
							}, (res) => {
								if(res.result){
