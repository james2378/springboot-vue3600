				...
				<div class="row">
						...
						<!-- 图片 -->
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/registration_reservation/edit','add')" @click="to_form('/registration_reservation/edit')" >挂号预约 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/department_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
