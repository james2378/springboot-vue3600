<template>
	<div class="diy_home diy_list diy_patient_medical_record" id="diy_patient_medical_record_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/patient_medical_record/details?patient_medical_record_id=' + o['patient_medical_record_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/patient_medical_record/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/patient_medical_record/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','appointment_name')">预约姓名
					</th>
					...
					<th class="diy_title" v-if="$check_field('get','disease_symptoms')">患病症状
					</th>
					<th class="diy_title" v-if="$check_field('get','cause_of_disease')">患病原因
					</th>
					<th class="diy_title" v-if="$check_field('get','medication_details')">用药详情
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','appointment_name')">
						<span>
							{{ o["appointment_name"] }}
						</span>
					</td>
					...
					<td class="diy_field diy_text" v-if="$check_field('get','disease_symptoms')">
						<span>
							{{ o["disease_symptoms"] }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','cause_of_disease')">
						<span>
							{{ o["cause_of_disease"] }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','medication_details')">
						<span>
