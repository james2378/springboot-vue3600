<template>
	<div class="diy_details page_department_information" id="department_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_department_information'>
							<div_department_information :obj="obj"></div_department_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_department_information from "@/components/diy/div_department_information.vue";
	import mixin from "@/mixins/page.js";
	export default {
		mixins:[mixin],
		components:{
			div_department_information
		},
		data(){
			return{
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/department_information/set?department_information_id=' + obj["department_information_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "department_information",
					source_field: "department_information_id",
					source_id: obj["department_information_id"],
					user_id
				};
