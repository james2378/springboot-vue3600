<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/patient_medical_record/table','add') || $check_action('/patient_medical_record/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/patient_medical_record/table','del') || $check_action('/patient_medical_record/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="disease_symptoms" label="患病症状"
				v-if="user_group == '管理员' || $check_field('get','disease_symptoms')" min-width="200">
			</el-table-column>
			<el-table-column prop="cause_of_disease" label="患病原因"
				v-if="user_group == '管理员' || $check_field('get','cause_of_disease')" min-width="200">
			</el-table-column>
			<el-table-column prop="medication_details" label="用药详情"
				v-if="user_group == '管理员' || $check_field('get','medication_details')" min-width="200">
			</el-table-column>
			...
			<el-table-column label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/patient_medical_record/table','set') || $check_action('/patient_medical_record/view','set') || $check_action('/patient_medical_record/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/patient_medical_record/table','set') || $check_action('/patient_medical_record/view','set') || $check_action('/patient_medical_record/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/patient_medical_record/get_list?like=0",
				url_del: "~/api/patient_medical_record/del?",
		...
		methods: {
			...
			export_db(tableid){
				...
				// this.$get("~/api/patient_medical_record/export_db?",query,(json)=>{
				// 	if(json.result){
