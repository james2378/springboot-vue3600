<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/nucleic_acid_appointment/table','add') || $check_action('/nucleic_acid_appointment/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/nucleic_acid_appointment/table','del') || $check_action('/nucleic_acid_appointment/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="reservation_number" label="预约编号"
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/nucleic_acid_appointment/table','set') || $check_action('/nucleic_acid_appointment/view','set') || $check_action('/nucleic_acid_appointment/view','get') || $check_action('/核酸结果/table','add') || $check_action('/核酸结果/view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/nucleic_acid_appointment/table','set') || $check_action('/nucleic_acid_appointment/view','set') || $check_action('/nucleic_acid_appointment/view','get')"
						:to="'./view?' + field + '=' + scope.row[field]"
						 size="small">
						<span>详情</span>
					</router-link>
					<!--跨表按钮-->
					<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/nucleic_acid_results/view')" v-if="user_group == '管理员' || $check_action('/nucleic_acid_results/table','add') || $check_action('/nucleic_acid_results/view','add')">
						<span>核酸结果</span>
					</el-button>
				</template>
			</el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/nucleic_acid_appointment/get_list?like=0",
				url_del: "~/api/nucleic_acid_appointment/del?",
