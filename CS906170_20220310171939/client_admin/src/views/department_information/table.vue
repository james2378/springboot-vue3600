<template>
	<el-main class="bg">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="doctor_head" label="医生头像"
				v-if="user_group == '管理员' || $check_field('get','doctor_head')" min-width="200">
				<template slot-scope="scope">
					<el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['doctor_head'])"
						:preview-src-list="[$fullUrl(scope.row['doctor_head'])]">
			...
			<el-table-column prop="remaining_number" label="剩余号数"
				v-if="user_group == '管理员' || $check_field('get','remaining_number')" min-width="200">
			</el-table-column>
			<el-table-column prop="department_profile" label="科室简介"
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/department_information/table','set') || $check_action('/department_information/view','set') || $check_action('/department_information/view','get') || $check_action('/挂号预约/table','add') || $check_action('/挂号预约/view','add')" >
